...
- [TBZ: Kubernetes Tutorial](../Kubernetes/Tutorial)
- [TBZ: Demo Projekt](../Kubernetes/Demo%20Project)
...
Erstellen Sie das [Demo Projekt](../Kubernetes/Demo%20Project) auf Ihrem eigenen Kubernetes Cluster (mit mind. 3 nodes). 
