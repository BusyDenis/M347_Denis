...
- [TBZ: Docker Compose](../Container/docker/DockerCompose.md)
...
- Die gelernten Cloud-Init-Anweisungen aus m346 reichen aus, um die Applikation zu installieren. [Sie kriegen hier ein vorbereitetes cloud-init, welches Docker installiert](KN04). Sie müssen die Bereiche **write_files** und **runcmd** erweitern.
- Fügen Sie Ihren und den [öffentlichen Schlüssel der Lehrperson](../PublicKey) hinzu, so dass die Lehrperson auf Ihren Server zugreifen kann.
